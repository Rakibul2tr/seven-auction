    ...
    return (
        <div>
            <Modal
                ...
                <button onClick={()=>setloginChange('login')}
                className={loginChange==='login'?'active':null}
                
                >Login</button>
                <button onClick={()=>setloginChange('register')}
                ...
                <div className="row px-5 py-2">
                    ...
                    <p className='login_p'><Link to='/'>use mobile</Link></p>
                </div>
                <div className="row px-5 py-2">
                    ...
                    <p className='login_p'><Link to='/'>forgot your password ? </Link></p>
                </div>
