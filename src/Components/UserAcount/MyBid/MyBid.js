        ...
        <div className="bid_body">
          <div className="bid_menu py-3">
            <button
              ...
              className={
                menuChange === "live" ? "bidMenuactive && live_btn" : null
              }
            >
              Live Auction
            </button>
            <button
              ...
              className={
                menuChange === "won" ? "bidMenuactive && won_btn" : null
              }
            >
              won
            </button>
            <button
              ...
              className={
                menuChange === "lost" ? "bidMenuactive && lost_btn" : null
              }
            >
              lost
            </button>
          ...
          {menuChange === "live" && (
            <LiveAuctionTabe
              Livecars={Livecars}
              bidedAuctions={bidedAuctions}
            />
          )}
          {menuChange === "won" && (
            <WonTabe Livecars={Livecars} bidedAuctions={bidedAuctions} />
          )}
          {menuChange === "lost" && (
            <LostTabe Livecars={Livecars} bidedAuctions={bidedAuctions} />
          )}
        </div>
      </Row>
    </Container>
